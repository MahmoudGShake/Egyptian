...
class Person:
	def __init__(self, language: str=None,gender: str=None, name_length: int=None,age: int=None,name: str=None,city: str=None,job_title:str=None,phone:str=None,
	             ...
	             phone_carrier:str=None,phone_start_with:str=None, user_name_lenght:int=None,birth_day=None,birth_month=None,birth_year=None,password_length:int=None,email_ends_with=None):
